...
function MapComponent() {
    ...
    return (
        <>
        <Container className="text-center mb-5 d-none d-lg-block" data-aos="fade-up" data-aos-duration="3000">
        ...
        <Container className="text-center mb-5 d-md-block d-lg-none" data-aos="fade-up" data-aos-duration="3000">
